...
static const float GRAVITATIONAL_CONSTANT = 6.673e-11;

static const float MAX_RANDOM = 1.0f;
static const float MAX_MASS = 1.66123412f;
static const float MAX_SPEED = 203.2343234f;
static const float MAX_ACCELERATION = 1.1234f;

static const int UNIVERSE_SIZE_X = 800;
static const int UNIVERSE_SIZE_Y = 800;
static const int UNIVERSE_SIZE_Z = 800;
